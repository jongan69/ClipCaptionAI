    ...
    <div className="flex-1 overflow-y-auto">
      <GlassPanel variant="strong" size="lg" className="max-w-2xl mx-auto mt-4">
        ...
        <p className="text-sm text-text-dim mb-6">
          CRF encoding with quality presets. Optimize video size without visible quality loss.
        </p>
        <div className="space-y-4">
          <div className="flex gap-2 items-end">
            ...
            <GlassButton
              size="md"
              onClick={async () => {
                const p = await pickFile({title: 'Select video'});
                if (p) setVideoPath(p);
              }}
            >
              Browse
          ...
          <GlassInput
            ...
            placeholder="1280:720 or 1920:1080"
            value={scale}
          ...
          {running && (
            <GlassProgress
              ...
              label={currentJob?.stage || 'Encoding...'}
            />
          )}
