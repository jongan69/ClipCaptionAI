    ...
    <div className="flex-1 overflow-y-auto">
      <GlassPanel variant="strong" size="lg" className="max-w-2xl mx-auto mt-4">
        ...
        <p className="text-sm text-text-dim mb-6">
          Add contextual cutaways, scene inserts, and captions to an existing video edit.
        </p>
        <div className="space-y-4">
          ...
          {running && (
            <GlassProgress
              ...
              indeterminate
              label={currentJob?.stage || 'Enhancing...'}
            />
          )}
          <div className="flex gap-3 pt-2">
            <GlassButton
              ...
              loading={running}
              onClick={() => run('enhance', 'Enhance with B-roll', {video: videoPath})}
            >
