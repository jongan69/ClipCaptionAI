    ...
    <div className="flex-1 overflow-y-auto">
      <GlassPanel variant="strong" size="lg" className="max-w-2xl mx-auto mt-4">
        ...
        <div className="space-y-4">
          ...
          <GlassInput label="Captions JSON (optional — auto-transcribes if empty)" placeholder="/path/to/captions.json" value={captionsPath} onChange={(e) => setCaptionsPath(e.target.value)} />
          ...
          {running && (
            <GlassProgress value={currentJob?.percent ?? 0} indeterminate={!currentJob?.percent} label={currentJob?.stage || "Rendering..."} />
          )}

          <div className="flex gap-3 pt-2">
            <GlassButton variant="primary" disabled={!videoPath || running} loading={running} onClick={handleCaption}>
